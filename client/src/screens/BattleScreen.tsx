...
const PREP_ROSTER: Teammate[] = [
  { id: 'char-caelum', name: 'Caelum', class: 'Tanque', level: 128, hp: 8645, maxHp: 8645, mp: 210, maxMp: 280, element: 'agua', position: 'front', portrait: '/assets/characters/caelum_face.png', rank: 'S', spells: [{ id: 'holy-barrier', name: 'Barreira Sagrada', cost: 10, desc: 'Dobra a defesa de aliados na mesma linha por 1 turno.' }] },
  { id: 'char-lyria', name: 'Lyria', class: 'Mago', level: 124, hp: 6215, maxHp: 6215, mp: 420, maxMp: 650, element: 'none', position: 'back', portrait: '/assets/characters/lyria_face.png', rank: 'S+', spells: [{ id: 'nova-astral', name: 'Nova Astral', cost: 4, desc: 'Causa 215% de dano mágico a todos os inimigos e aplica Vulnerável por 2 turnos. Recarga: 3 turnos.' }, { id: 'cure', name: 'Chama Curativa', cost: 10, desc: 'Restaura HP de um companheiro ferido.' }] },
  { id: 'char-raven', name: 'Raven', class: 'Assassino', level: 127, hp: 6085, maxHp: 6085, mp: 200, maxMp: 260, element: 'terra', position: 'mid', portrait: '/assets/characters/raven_face.png', rank: 'S', spells: [{ id: 'shadow-strike', name: 'Golpe Sombrio', cost: 15, desc: 'Ataca ignorando 30% da armadura do oponente.' }] },
  { id: 'char-seraphina', name: 'Seraphina', class: 'Clériga', level: 121, hp: 6500, maxHp: 6500, mp: 180, maxMp: 220, element: 'none', position: 'front', portrait: '/assets/characters/seraphina_face.png', rank: 'A', spells: [{ id: 'earth-smash', name: 'Impacto Sísmico', cost: 12, desc: 'Ataca atordoando o alvo no turno atual.' }] },
  ...
  { id: 'char-korr', name: 'Korr', class: 'Lanceiro', level: 119, hp: 8120, maxHp: 8120, mp: 180, maxMp: 250, element: 'fogo', position: 'front', portrait: '/assets/characters/korr_face.png', rank: 'A', spells: [{ id: 'fire-charge', name: 'Investida Ígnea', cost: 12, desc: 'Avança causando dano com chance de aplicar queimadura.' }] }
];
...
export const BattleScreen: React.FC<BattleScreenProps> = ({ roomId, onFinishBattle }) => {
  ...
  if (battleState.status === "finished") {
    ...
    // Stats values matching the beautiful mockup
    const totalDamage = "22.814";
    const totalHealing = "8.748";
    const totalShields = "6.305";
